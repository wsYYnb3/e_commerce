      ...
      <Container>
        <Row className="justify-content-center">
          <Col xs={12} md={8} lg={6}>
            ...
            <ContactCard>
              <Card.Body>
                <Card.Title><FaEnvelope /> Email Support</Card.Title>
                <Card.Text>support@yielddeal.com</Card.Text>
              </Card.Body>
            </ContactCard>
            <ContactCard>
              <Card.Body>
                <Card.Title><FaPhone /> Phone Support</Card.Title>
            ...
            >
              <Form>
                ...
                <Field id="email" name="email" placeholder="john.doe@example.com" type="email" className="form-control" />

                <label htmlFor="message" className="mt-3">Message</label>
                <Field id="message" name="message" as="textarea" rows="3" className="form-control" />
